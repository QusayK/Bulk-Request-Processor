...
var cmds = {
    commands: [
        ...
        {
            verb: "POST",
            url: "http://www.mocky.io/v2/5d99a2c6310000550097d992/test",
            params: [
                {
                    param1: "55"
                },
...
var sentRequests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var commands, requests, tempReqs, interval;
    return __generator(this, function (_a) {
        commands = cmds.commands;
        requests = [];
        tempReqs = [];
        commands.map(function (cmd) { return __awaiter(void 0, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                cmd.params.forEach(function (params) {
                    //url = cmd.url.replace(`param${index+1}`, params[`param${index+1}`]);
                    var _params = '';
                    var keys = Object.keys(params);
                    keys.forEach(function (key, index) {
                        _params += index < keys.length - 1 ? params[key] + "/" : "" + params[key];
                    });
                    var tempURL = cmd.url.split("/");
                    tempURL[tempURL.length - 1] = _params;
                    url = tempURL.join("/");
                    console.log("url", url);
                    requests.push({ url: url, method: cmd.verb });
                });
                return [2 /*return*/];
            });
        }); });
                ...
                switch (_a.label) {
                    case 0:
                        tempReqs = requests.splice(0, 10)
                            .map(function (req) { return axios_1.default.request({ url: req.url, method: req.method }); });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, Promise.allSettled(tempReqs)];
                    case 2:
                        res = _a.sent();
